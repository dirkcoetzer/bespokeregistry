        ...
        <tr>
          <td>
            <font face="Georgia, Times New Roman, Times, serif" size="2" color="#626262">
                <?php echo $order->registry->title; ?> has been finalized.<br/>
                Client Order ID: <?php echo $order->id; ?> was approved and processed.<br/>
                <br/>
                The client still had a credit on their account and an automatic voucher was generated for the outstanding credit.<br/>
                Voucher Amount: R <?php echo $balance; ?><br/>
            </font>
          </td>
        </tr>
    </table>
