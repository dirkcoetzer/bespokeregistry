        ...
        <tr>
          <td>
            <font face="Georgia, Times New Roman, Times, serif" size="2" color="#626262">
                ...
                <br/>
                Our administration staff have updated your order and flagged some products which we have found are out of stock.<br/>
                <br/>
                Please log into your registry and update the quantities on your order.<br/>
                <a href="<?php echo $this->createAbsoluteUrl("order/process", array("rid" => $order->registry_id)); ?>" target="_blank">My Registry - Order My Gifts</a><br/>
                <br/>
                If you have any queries please do not hesitate to call or email us.<br/>
                <br/>
                Kind regards,<br/>
                Laura Hau<br/>
                e: <?php echo Yii::app()->params['adminEmail']; ?>
            </font>
          </td>
        </tr>
    </table>
