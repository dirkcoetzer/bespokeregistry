    ...
    */
    ...
    public function actionProcess(){
        ...
        if (!$modelOrder){
            ...
            $modelOrder->status = '';
            $modelOrder->first_name = $order->registry->owner->profile->firstname;
            $modelOrder->last_name = $order->registry->owner->profile->lastname;
            $modelOrder->mobile_phone = '';
            $modelOrder->message = '';
            $modelOrder->email = $order->registry->owner->profile->email;
            $modelOrder->remain_anonymous = 0;
            $modelOrder->street = $order->registry->owner->profile->street;
            $modelOrder->suburb = '';
            $modelOrder->city = $order->registry->owner->profile->city;
