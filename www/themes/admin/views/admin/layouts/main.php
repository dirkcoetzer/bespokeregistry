...
<div class="container" id="page">
	...
	<div id="header">
		...
		<img style="padding: 0; margin: 0;" src="<?php echo Yii::app()->theme->baseUrl; ?>/images/admin-header.jpg" alt="Bespoke Admin Area" />
	</div><!-- header -->
	...
	<div id="footer">
		Copyright &copy; <?php echo date('Y'); ?> by Bespoke Registry.<br/>
