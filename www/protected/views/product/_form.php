...
<?php $form=$this->beginWidget('CActiveForm', array(
    ...
    <div class="row">
		...
		<?php echo $form->textField($model,'sku',array('size'=>50,'maxlength'=>150)); ?>
	...
	<div class="row">
		...
		<?php echo $form->textField($model,'price',array('size'=>10,'maxlength'=>10)); ?> <?php echo $form->checkBox($model,'apply_price_recursively',array('value'=>1)); ?> Apply price recursively
