...
class RegistryProduct extends BespokeRegistryActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('registry_id, product_id, contribution_item, qty_requested, priority_item, created_by, created_date, modified_by, modified_date', 'numerical', 'integerOnly'=>true),
