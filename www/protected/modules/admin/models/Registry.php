...
class Registry extends BespokeRegistryActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, title, owner_id, event_date, image, image_thumb, message, email, mobile_phone, home_phone, address, created_by, created_date, modified_by, modified_date', 'safe', 'on'=>'search'),
		);
	}
