...
class RegistryProduct extends BespokeRegistryActiveRecord
{
    ...
    public function isContributionItem($registry_id, $product_id){
        $item = $this->findByAttributes(array('registry_id' => $registry_id, 'product_id' => $product_id));
        return $item->contribution_item;
    }
}